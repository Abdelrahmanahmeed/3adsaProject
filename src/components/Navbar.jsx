...
import logo from "../assets/imgaes/Logo-BWCRNJlt.png"
     ...
     <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link to="/blog" className="btn-primary px-5 py-2.5 rounded-full  bg-linear-to-r from-orange-500 to-orange-600 text-white text-sm">
              ابدأ القراءة
            </Link>
          </div>
            ...
            <div className='flex flex-col space-y-1'>
              ...
              <NavLink  to="/about" onClick={() => setIsOpen(false)}
               ...
               >
                ...
                className="btn-primary px-5 py-2.5 rounded-full  bg-linear-to-r from-orange-500 to-orange-600 text-white text-sm"
              >
                ابدأ القراءة
              </Link>
            </div>
