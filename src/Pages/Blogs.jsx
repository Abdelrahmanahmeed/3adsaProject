...
const resetFilters = () => {
  ...
  const allArticles = DataPosts.posts.map((post) => ({
    id : post.id,
    title : post.title,
...
const totalPages = Math.ceil (filteredArticles.length / articlePerPage)
const safeCurrentPage = totalPages === 0 ? 1 : Math.min(currentPage, totalPages);
const startIndex = (safeCurrentPage - 1) * articlePerPage ;
    ...
    <main className="grow pt-20">
      <div className="min-h-screen bg-[#0a0a0a]">
         <div className="relative py-24 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 scroll-mt-36" >
          ...
          {currentArticles.length === 0 ? (
            <div className="text-center py-20">
              ...
              <button
                ...
                className="px-6 py-3 bg-linear-to-r from-orange-500 to-orange-600 text-white rounded-xl font-medium hover:from-orange-600 hover:to-orange-700 transition-all duration-300 inline-flex items-center gap-2 shadow-lg shadow-orange-500/20"
              >
            ...
            <>
              {viewMode === "grid" && (
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {currentArticles.map((article) => (
                    <article
                      key={article.id}
                      className="group overflow-hidden rounded-2xl border border-[#262626] bg-[#0a0a0a] transition-all duration-500 hover:-translate-y-1 hover:border-orange-500/30"
              ...
              <p className="text-center text-neutral-500 mt-4 text-sm">
                صفحة {safeCurrentPage} من {totalPages || 1}
              </p>
            </>
          )}
          </div>
